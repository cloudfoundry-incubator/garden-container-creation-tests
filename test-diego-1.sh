...
test_stage() {
  ( cf push max -p assets/apps/max -m 512M >> max1-diego-1.log ) &
  ( cf push max2 -p assets/apps/max -m 512M >> max2-diego-1.log ) &
  ( cf push max3 -p assets/apps/max -m 512M >> max3-diego-1.log ) &
  check_state max 1
  check_state max2 1
  check_state max3 1
  sleep 2
